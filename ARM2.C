...
polytype3d cube3,body3,head3,head3r,
	   lefteye3,lefteye3r,righteye3,righteye3r,arm3,target3;
polytype2d cube2,body2,head2,lefteye2,righteye2,arm2,target2;

int        theta,phi,gazex,gazexle,gazexre,gazey,
	   phi2,theta2,phi2le,phi2re,d,
	   headwidth,headheight,neck,eyesize;
...
void main()
{
 ...
 while(ch != 'q')
 {
  ...
  if(!test1) 
  link3to2();    /* second kinesthetic level */
